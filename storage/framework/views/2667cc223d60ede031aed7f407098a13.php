    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo e(url('/dashboard/tasks')); ?>">Tasks</a>
            </li>
            <li class="nav-item">
...
</html><?php /**PATH /Users/novan/Documents/XAMPP/xamppfiles/htdocs/WebProg/Project/resources/views/tasks.blade.php ENDPATH**/ ?>